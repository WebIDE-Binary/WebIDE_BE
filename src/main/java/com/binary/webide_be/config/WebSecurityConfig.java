package com.binary.webide_be.config;

import com.binary.webide_be.jwt.JwtAuthFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .requestMatchers("**").permitAll()                // TODO: 2024/03/12 나중에 지워야됨 테스트용
...
//        config.addAllowedOrigin("{프론트aws배포주소}.ap-northeast-2.amazonaws.com");
//        config.addAllowedOrigin("{프론트aws배포주소}.s3-website.ap-northeast-2.amazonaws.com/");
//        config.addAllowedOrigin("https://{프론트 버쉘 배포}/");
//        config.addAllowedOrigin("https://{도메인}.shop/");
//        //채팅 테스트용 origin
